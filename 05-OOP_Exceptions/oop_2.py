...
class Teacher(Member):
    ...
    @staticmethod
    def create_homework(hw_text, hw_days):
        return Homework(hw_text, hw_days)

    def check_homework(self, homework_result):
        if len(homework_result.solution) > 5:
            result = [homework_result.author, homework_result.solution]
            if result not in Teacher.homework_done[homework_result.homework]:
                Teacher.homework_done[homework_result.homework].append(result)
            return True
        return False
